...
module.exports = {
  ...
  onStart: async({ api, event, args }) => {
    ...
    if (!prompt) return api.sendMessage("❌| Wrong Format. ✅ | Use: 17/18 years old boy/girl watching football match on TV with 'Shifat' and '69' written on the back of their dress, 4k", event.threadID, event.messageID);
    try {
